...
class GitHubClient:
    ...
    def query(self, query: str, variables: Dict = None) -> Dict:
        ...
        print(f"GitHub Client: Making request to {self.base_url}")
        print(f"GitHub Client: Headers: {self.headers}")
    ...
    def fetch_pull_requests(self, owner: str, repo: str, first: int = 50) -> List[Dict]:
        ...
        print(f"GitHub Client: Sending query with token: {bool(self.token)}")
        print(f"GitHub Client: Headers: {self.headers}")
        ...
        try:
            ...
            if "repository" not in data:
                print(f"GitHub Client: No repository in response. Full response: {data}")
                return []
